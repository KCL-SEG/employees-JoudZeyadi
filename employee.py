...
class Employee():
    ...
    def __str__(self):
        if self.monthHour == "month" and self.commission == 0:
            ...
            string = f"{self.name} works on a monthly salary of {self.salary} and receives a commission for {self.cContract} contract(s) at {self.cContractWage}/contract.  Their total pay is {self.get_pay()}."
        elif self.monthHour == "month" and self.commission == 2:
